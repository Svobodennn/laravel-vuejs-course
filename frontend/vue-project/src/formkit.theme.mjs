/**
  ...
  *
  * @checksum - df8866fccf6537aeceafead9a9920d1dc69728c710a5722461c80b82299f287e
  * @variables - 
  * @theme - regenesis
  **/
...
const classes = {
  ...
  "family:button__input": {
    ...
    "text-blue-600": true,
    "group-[&]/repeater:shadow-xs": true,
    "group-[&]/multistep:shadow-xs": true,
  ...
  "family:dropdown__inner": {
    ...
    "border-neutral-400": true,
    "rounded-sm": true,
    "group-data-[is-multiline]:!rounded-sm": true,
    "focus-within:ring-1": true,
    "focus-within:!ring-blue-500": true,
    "focus-within:!border-blue-500": true,
    "group-data-[invalid]:border-red-500": true,
  ...
  "family:dropdown__listitem": {
    ...
    "before:inset-0": true,
    "data-[is-active]:first:before:rounded-sm": true,
    "data-[is-active]:first:before:rounded-b-none": true,
    "data-[is-active]:last:before:rounded-sm": true,
    "data-[is-active]:last:before:rounded-t-none": true,
    "data-[is-active]:first:last:before:rounded-sm": true,
  ...
  "file__inner": {
    "relative": true,
    "cursor-pointer": true,
    "group-data-[has-multiple]:rounded-sm": true
  },
  "file__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "form__messageLink": {
    "group-[&]/summary:outline-hidden": true,
  ...
  "range__input": {
    ...
    "[&::-webkit-slider-runnable-track]:rounded-sm": true,
    ...
    "[&::-moz-range-track]:rounded-sm": true,
  ...
  "select__inner": {
    ...
    "group-[&]/repeater:shadow-none": true,
    "group-[&]/multistep:shadow-none": true,
    "group-data-[multiple]:rounded-sm": true,
    "dark:bg-transparent": true,
    "dark:border-neutral-500": true,
    "dark:group-data-[disabled]:bg-neutral-800/5": true,
    "dark:group-data-[invalid]:border-red-500": true,
  ...
  "select__option": {
    ...
    "group-data-[multiple]:outline-hidden": true,
  ...
  "colorpicker__inner": {
    ...
    "group-data-[inline]:outline-hidden": true,
    "group-data-[inline]:!ring-0": true,
    "group-data-[inline]:!w-full": true,
    "group-data-[inline]:rounded-sm": true
  },
  ...
  "colorpicker__fieldGroup": {
    ...
    "[&>input:focus]:outline-hidden": true,
  ...
  "colorpicker__swatch": {
    ...
    "[&>canvas]:rounded-sm": true,
    "[&>canvas:focus-visible]:outline-hidden": true,
  ...
  "togglebuttons__input": {
    ...
    "group-data-[vertical=false]/options:group-first/option:!rounded-sm": true,
    "group-data-[vertical=true]/options:group-first/option:!rounded-sm": true,
    ...
    "group-data-[vertical=false]/options:group-last/option:!rounded-sm": true,
    "group-data-[vertical=true]/options:group-last/option:!rounded-sm": true,
  ...
  "multi-step__wrapper": {
    ...
    "data-[tab-style=tab]:rounded-sm": true
  },
  "multi-step__tabs": {
    "flex": true,
    "items-center": true,
    ...
    "group-data-[tab-style=tab]/wrapper:rounded-sm": true,
